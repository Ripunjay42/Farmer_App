...
export default function OnboardingScreen2() {
  ...
  const handleBack = () => {
    ...
    setTimeout(() => router.push('/onboarding/screen1'), 100);
    ...
    <View className="flex-1 bg-gray-100">
      ...
      <Animated.View style={animatedStyle} className="flex-1 items-center justify-center">
        ...
        <Text className="text-gray-500 text-center text-md leading-6 mb-10 max-w-xs">
          our project can detect plant and soil
          diseases using an existing camera
          sensor that tracks the plants in real-time day by day.
        </Text>
