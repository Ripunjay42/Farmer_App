    ...
    <View className="flex-1 bg-gray-950">
      ...
      <View className="flex-1 bg-black/20">
        ...
        <View className="items-center pt-20 pb-8">
          ...
          <Text className="text-white text-2xl font-bold mb-2">Log In</Text>
          <Text className="text-white/80 text-base">please sign in to continue</Text>
        </View>

        {/* Login Form */}
        <View className="bg-white/10 backdrop-blur-lg mx-6 rounded-3xl p-6">
          {/* Phone Number Input */}
          <View className="mb-4">
          ...
          <View className="flex-row items-center mb-6">
            ...
            <Text className="text-white/70 mx-4 text-sm">or sign in with</Text>
            <View className="flex-1 h-px bg-white/30" />
          </View>
